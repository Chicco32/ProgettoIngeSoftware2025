...
public enum CliNotifiche {
    ...
    ISCRIZIONE_IMPOSSIBILE("L'iscrcione con questi parametri non è possibile, controlla che il numero di partecipanti non superi il massimo consentito o che la visia sia disponibile"),
